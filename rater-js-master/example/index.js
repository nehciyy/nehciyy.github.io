function onload(event) {
  ...
  var starRating1 = raterJs( {
    starSize:32,
    element:document.querySelector("#rater-2"),
    rateCallback:function rateCallback(rating, done) {
      this.setRating(rating);
      done();
    }
  ...
  var starRating1 = raterJs( {
    starSize:32,
    element:document.querySelector("#rater-3"),
    rateCallback:function rateCallback(rating, done) {
      this.setRating(rating);
      done();
    }
  ...
  var starRating1 = raterJs( {
    starSize:32,
    element:document.querySelector("#rater-4"),
    rateCallback:function rateCallback(rating, done) {
      this.setRating(rating);
      done();
    }
  ...
  var starRating1 = raterJs( {
    starSize:32,
    element:document.querySelector("#rater-5"),
    rateCallback:function rateCallback(rating, done) {
      this.setRating(rating);
      done();
    }
  ...
  var starRating1 = raterJs( {
    starSize:32,
    element:document.querySelector("#rater-6"),
    rateCallback:function rateCallback(rating, done) {
      this.setRating(rating);
      done();
    }
